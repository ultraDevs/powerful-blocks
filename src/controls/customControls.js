        ...
        return (
            <Fragment>
                ...
                <InspectorControls>
                    ...
                    { typo_blocks.includes( props.name ) && (
                        <PanelBody title={ __( 'Typography', 'powerful-blocks' ) }>
                            <TypographyControl
                                label = { __( 'Typography', 'powerful-blocks' ) }
                                fontFamily = { { value: pbFontFamily, name: 'pbFontFamily' } }
                                sizeType = {
                                    { value: pbFontSizeType, name: 'pbFontSizeType' }
                                }
                                fontSize = { { value: pbFontSize, name: 'pbFontSize' } }
                                fontSizeTablet = { { value: pbFontSizeTablet, name: 'pbFontSizeTablet' } }
                                fontSizeMobile = { { value: pbFontSizeMobile, name: 'pbFontSizeMobile' } }
                                fontStyle = { { value: pbFontStyle, name: 'pbFontStyle' } }
                                fontWeight = { { value: pbFontWeight, name: 'pbFontWeight' } }
                                lineHeight = { { value: pbLineHeight, name: 'pbLineHeight' } }
                                letterSpacing = { { value: pbLetterSpacing, name: 'pbLetterSpacing' } }
                                textTransform = { { value: pbTextTransform, name: 'pbTextTransform' } }
                                textDecoration = { { value: pbTextDecoration, name: 'pbTextDecoration' } }
                                                    ...
                                                    <div className="pb-panel-s--tabs__controls">
                                                        ...
                                                        <>
                                                            <ColorPickerControl
                                                                ...
                                                                value={ pbBackgroundColor }
                                                                onChange={ ( pbBackgroundColor ) => {
                                                                    setAttributes( { pbBackgroundColor } );
                                                                } }
                                                            />
                                                        </>
                                                        ) }
                            ...
                            'Free' === pType ? (
                                ...
                                <>
                                    ...
                                    <ToggleControl
                                        ...
                                        onChange={ ( nValue ) => {
                                            setAttributes( { wrapperLinkNofollow: nValue } );
                                        } }
                                    />
                                </>
                            )
...
wp.hooks.addFilter( 'editor.BlockEdit', 'powerful-blocks/bg-controls', withInspectorControls );