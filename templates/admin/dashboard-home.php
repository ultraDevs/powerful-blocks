<div class="ud-row">
	<div class="ud-col">
		<div class="ud-box">
			<div class="ud-box-header">
				<h2>Welcome, <?php echo wp_get_current_user()->display_name; ?> ❤️</h2>
			</div>
			<div class="ud-box-content">
				<p>Thanks for choosing <strong>Powerful Blocks</strong></p>
				<h3>What You Are Getting</h3>
				<ul>
					<li>13 Blocks</li>
					<li>Advance and <strong>Unique</strong> Block Controls</li>
				</ul>

				<h3>Upcoming</h3>
				<ul>
					<li>Some Cool Blocks</li>
	...
	<div class="ud-col">
		<div class="ud-box">
			...
			<div class="ud-box-content">
				...
				<a class="ud-btn-lm" href="https://docs.powerfulblocks.com" target="_blank">Read Documentation</a>
			</div>
		</div>
	</div>
	<div class="ud-col">
	...
	<div class="ud-col">
		<div class="ud-box">
			...
			<div class="ud-box-content">
				<p>You can ask for any type of custom <strong>block</strong></p>
				<p>* Please Upgrade to any plan!</p>
				<a class="ud-btn-lm" href="https://powerfulblocks.com/custom-block" target="_blank">Ask Here</a>
			</div>
		</div>
	</div>
</div>
